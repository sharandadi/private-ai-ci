...
class ReportAgent(autogen.AssistantAgent):
    def __init__(self, name="Reporter", llm_config=None):
        ...
        4. **Test Results**: detailed breakdown of the tests run.
           - YOU MUST COPY THE EXACT OUTPUT of the test execution (including "====" separators, "Status Code", "Response"). 
           - Do not summarize or format it differently. Show the raw logs of the test run.
